...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ChartErrorBars = {}));
  ...
  */ const requestAnimFrame = function() {
  ...
  class Animation {
      constructor(cfg, target, prop, to){
          ...
          this._active = true;
          this._fn = cfg.fn || interpolators$1[cfg.type || typeof from];
  ...
  function generateBarTooltip(item) {
      ...
      const base = plugin_tooltip.defaults.callbacks.label.call(this, item);
  ...
  registry.addControllers(BarWithErrorBarsController, LineWithErrorBarsController, PolarAreaWithErrorBarsController, ScatterWithErrorBarsController);
